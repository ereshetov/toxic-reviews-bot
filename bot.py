...
# Города для поиска заведений (весь мир)
CITIES = [
    # СНГ
    ...
    # Турция
    "Стамбул", "Анталья", "Аланья", "Бодрум", "Кемер", "Мармарис",
    # ОАЭ
    "Дубай", "Абу-Даби", "Шарджа",
    # Европа
    "Париж", "Барселона", "Рим", "Милан", "Прага", "Вена", "Берлин",
    "Амстердам", "Лондон", "Мадрид", "Лиссабон", "Будапешт", "Варшава",
    "Афины", "Никосия", "Ларнака", "Пафос", "Черногория", "Белград",
    # Азия
    "Пхукет", "Паттайя", "Бангкок", "Бали", "Гоа", "Дели", "Шанхай",
    "Пекин", "Гонконг", "Сингапур", "Сеул", "Токио", "Ханой", "Хошимин",
    # Египет
    "Шарм-эль-Шейх", "Хургада", "Каир",
    # Другие
    "Нью-Йорк", "Лос-Анджелес", "Майами", "Тель-Авив", "Иерусалим",
    "Тбилиси", "Батуми", "Рига", "Таллин", "Вильнюс"
]
